...
DESCRIPTION="SOX with ladspa-multiport support."
HOMEPAGE="http://sourceforge.net/p/sox/patches/92/"
EGIT_REPO_URI="git://bogomips.org/sox.git"
EGIT_BRANCH="ladspa-multiport"
...
src_prepare() {
	epatch \
		"${FILESDIR}"/sox-14.4.0-ffmpeg.patch \
		"${FILESDIR}"/sox-14.4.1-ffmpeg2.patch
